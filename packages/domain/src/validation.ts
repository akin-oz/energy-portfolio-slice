...
export function assertCustomerExists(customer: Customer | undefined | null, id: ID): void {
  if (!customer) {
    throw new Error(`Customer ${id} not found`);
  }
}

export function assertProjectExists(project: Project | undefined | null, id: ID): void {
  if (!project) {
    throw new Error(`Project ${id} not found`);
  }
}

export function assertEnergyAssetExists(asset: EnergyAsset | undefined | null, id: ID): void {
  if (!asset) {
